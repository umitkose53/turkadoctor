...
import { doctorsLiv } from "./doctors-liv";
import { doctorsCukurova } from "./doctors-cukurova";
import { doctorsCerrahpasa } from "./doctors-cerrahpasa";
import { doctorsIstanbulUniversitesi } from "./doctors-istanbul-universitesi";
import { doctorsHacettepe } from "./doctors-hacettepe";
import { doctorsAnkaraUniv } from "./doctors-ankara-univ";
import { doctorsGazi } from "./doctors-gazi";
import { doctorsAkdeniz } from "./doctors-akdeniz";
import { doctorsAtaturk } from "./doctors-ataturk";
import { doctorsDokuzEylul } from "./doctors-dokuz-eylul";
import { doctorsErciyes } from "./doctors-erciyes";
import { doctorsKtu } from "./doctors-ktu";
import { doctorsMarmara } from "./doctors-marmara";
import { doctorsOmu } from "./doctors-omu";
import { doctorsUludag } from "./doctors-uludag";
...
import { doctorsYildirimBeyazit } from "./doctors-yildirim-beyazit";
import { doctorsPamukkale } from "./doctors-pamukkale";
import { doctorsBilkentSehir } from "./doctors-bilkent-sehir";
...
const doctorsPrimary: DoctorSummary[] = [
  ...
  },
  {
    ...
    signals: [
      ...
      // Trustpilot ve WhatClinic: doktor düzeyinde puan/sayı göstermez (mevzuat: yalnız "aktif profil" + link)
      {
        source: "trustpilot",
        sourceUrl: "https://www.trustpilot.com/review/www.smilehairclinic.com",
        visible: true,
      },
      {
        source: "whatclinic",
        sourceUrl:
          "https://www.whatclinic.com/hair-loss/turkey/istanbul-province/istanbul/atasehir/smile-hair-clinic",
        visible: true,
      },
    ],
  },
  ...
  },
  {
    ...
    signals: [
      ...
      {
        source: "trustpilot",
        sourceUrl: "https://www.trustpilot.com/review/www.estepalace.com",
        visible: true,
      },
      {
        source: "whatclinic",
        sourceUrl:
          "https://www.whatclinic.com/hair-loss/turkey/istanbul-province/istanbul/kagithane/estepalace",
        visible: true,
      },
    ],
  },
  ...
  // ═══════════════ İSTANBUL — ESTETİK CERRAHİ ═══════════════
  {
    ...
    signals: [
      ...
      // Trustpilot/WhatClinic: este-istanbul için doğrulanmış profil bulunamadı; gizli.
      { source: "trustpilot", visible: false },
    ],
  },
  {
  ...
  },
  {
    ...
    signals: [
      ...
      {
        source: "trustpilot",
        sourceUrl: "https://www.trustpilot.com/review/acibademhealthpoint.com",
        visible: true,
      },
    ],
  },
  ...
  },
  {
    ...
    signals: [
      { source: "google_places", ratingAvg: 4.8, reviewCount: 312, visible: true },
      // Trustpilot: antalya-estetik-international için doğrulanmış profil bulunamadı.
      { source: "trustpilot", visible: false },
    ],
  },
  {
